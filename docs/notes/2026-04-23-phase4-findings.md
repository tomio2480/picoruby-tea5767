...
Phase 4 として `firmware/` 下の純ロジック 3 本（TEA5767 / SpectrumScanner / SerialEmitter）を TDD で実装した．結果は 22 tests / 38 assertions 緑で，実機不要で設計を固め切れた．`main.rb` は PicoRuby R2P2 想定の結線コードで CRuby テスト対象外．
